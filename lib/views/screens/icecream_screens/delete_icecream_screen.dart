...
class DeleteIceCream extends StatefulWidget {
  const DeleteIceCream({super.key});
  static const routeName = '/delete_iceCream';

  @override
  State<DeleteIceCream> createState() => _DeleteIceCreamState();
}

class _DeleteIceCreamState extends State<DeleteIceCream> {
  //
